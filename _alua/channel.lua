...
--
function
_alua.channel.client(host, port, read, write, close, s)
...
--
function
_alua.channel.server(port, read, write, conn, close)
	-- Bind the socket.
...
--
function
_alua.channel.setpattern(sock, pattern)
	local _, context = _alua.event.get(sock)
